      ...
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <button
            onClick={handleSave}
            disabled={!hasChanges}
            className={`w-full btn-primary flex items-center justify-center ${!hasChanges ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                value={user?.name || ''}
                disabled
                className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm bg-gray-50 dark:bg-gray-700"
              />
            </div>
